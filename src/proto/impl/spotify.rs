...
use crate::sharify::spotify::web_utils;
...
impl From<web_utils::SpotifyCurrentPlaybackOutput> for proto::spotify::PlaybackState {
    fn from(state: web_utils::SpotifyCurrentPlaybackOutput) -> Self {
        Self {
...
impl From<proto::spotify::Track> for web_utils::SpotifyTrack {
...
impl From<web_utils::SpotifyTrack> for proto::spotify::Track {
    fn from(track: web_utils::SpotifyTrack) -> Self {
        Self {
            track_id: track.track_id,
            track_name: track.track_name,
            artist_name: track.artist_name,
...
impl From<proto::spotify::TrackArray> for web_utils::SpotifyTackArray {
    fn from(tracks: proto::spotify::TrackArray) -> Self {
        tracks.tracks.into_iter().map(Into::into).collect()
    }
}

impl From<web_utils::SpotifyTackArray> for proto::spotify::TrackArray {
    fn from(tracks: web_utils::SpotifyTackArray) -> Self {
        Self {
            tracks: tracks.into_iter().map(Into::into).collect(),
        }
    }
